...
/**
 * @Author: panghai
 * @Date: 2022/06/25/10:03
 * @Description: 根据传入的参数生成svg
 */
public class MultiAvatar {
    ...
    /**
     * 根据传入的参数进行散列，用散列值生成SVG代码
     * @param avatarId 名称
     * @return SVG代码
     */
    public static String multiavatar(String avatarId) {
        if (avatarId == null || "".equals(avatarId)) {
            avatarId = "" + System.currentTimeMillis();
        }
        String hash = SHA256Util.getSHA256String(avatarId);
        StringBuilder script = getMultiAvatarJS();
        String SVG = "";
        try {
            ...
            // 执行函数
            SVG = (String) inv.invokeFunction("multiavatar", hash);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return SVG;
    ...
    public static StringBuilder getMultiAvatarJS() {
        StringBuilder sb = new StringBuilder();
        sb.append("// Multiavatar v1.0\n" +
                "\n" +
        ...
        sb.append("\n" +
                ...
                "  // PHP_inject_end\n" +
                "\n" +
                "  var sha256Numbers = hash.toString().replace(/\\D/g,'');\n" +
